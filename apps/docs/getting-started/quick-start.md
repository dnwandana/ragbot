...
You'll need an account and at least one document to upload (a PDF, Word file, or plain text). Anything you already use to answer questions — a handbook, a policy doc, meeting notes — works perfectly.
:::
...
<Steps>
  ...
  <Step title="Upload your documents">
    <p>Drag your files into the dataset, or browse to select them. RAGBot uploads each one and begins <strong>processing</strong> it — reading and indexing the text so it can be searched. A document shows <strong>Processing</strong> while it works and <strong>Ready</strong> when it's done.</p>
  </Step>
