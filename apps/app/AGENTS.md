...
| `useInvitationsStore`   | `stores/invitations.js`   | `myInvitations`, `loading`                                                               | `fetchMyInvitations` (no-op stub; backend not yet wired), `inviteToWorkspace`, `acceptInvitation`          | Partial |
...
| `useInvitations`   | `composables/useInvitations.js`   | `myInvitations`, `loading`, invite modal state, invite/accept                                                                                                                                                                                                                                                                 |
...
| `AppSidebar`           | `components/AppSidebar.vue`                    | Workspace-scoped navigation menu — reads `:workspaceId` from the route, lists conversations, permission-gated links, theme toggle (the invitations pending-count badge was removed; invitations are not yet fully wired)             |
