...
| `DatasetDrawer`        | `components/chat/DatasetDrawer.vue`            | Read-only "Linked sources" drawer showing the conversation's linked-dataset count; directs the user to the conversations list to change datasets        |
...
| `FileDetailPanel`      | `components/datasets/FileDetailPanel.vue`      | Panel showing a dataset file's metadata, type, and processing status                                                                                    |
