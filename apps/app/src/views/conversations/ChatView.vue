  ...
  <div class="chat-shell" :class="{ 'chat-shell--sources': showSources }">
    ...
    <aside class="chat-sidebar">
      <div class="csb-hd">
        <button
          class="btn-new-chat"
          @click="$router.push(`/workspaces/${workspaceId}/conversations`)"
        >
          <svg
            width="13"
            height="13"
    ...
    <div class="chat-area">
      ...
      <div class="chat-header">
        ...
        <div class="chat-header__info">
          ...
          <div class="chat-datasets">
            <span v-for="did in conversation?.dataset_ids || []" :key="did" class="ds-chip"
              >Dataset</span
            >
          </div>
        </div>
        ...
        >
          ...
          >
            <path
              d="M3 2h10a1 1 0 011 1v10a1 1 0 01-1 1H3a1 1 0 01-1-1V3a1 1 0 011-1zM8 5v6M5 8h6"
      ...
      <!-- Mobile sources pill -->
      <div
        v-if="citations.length && !showSources"
        class="mobile-pill"
...
.csb-item.active .csb-item__title {
  font-weight: 500;
  color: var(--ink);
}
.csb-item__time {
