  ...
  <AuthShell>
    <div class="auth-card">
      ...
      <a-form layout="vertical" @finish="handleSubmit">
        <a-form-item name="password" :rules="[{ required: true, min: 8, message: 'Password must be at least 8 characters' }]">
...
:deep(.ant-input-affix-wrapper) { background: var(--surface); border-color: var(--line-2); border-radius: var(--r-sm); }
:deep(.ant-input-affix-wrapper-focused) { border-color: var(--brand); box-shadow: 0 0 0 3px rgba(255,107,53,0.12); }
