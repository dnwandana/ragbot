...
:deep(.ant-modal-header) { padding: 20px 24px 16px; border-bottom: 1px solid var(--color-border); }
...
:deep(.ant-input), :deep(.ant-input-textarea textarea) { background: var(--color-bg) !important; border-color: var(--color-border) !important; border-radius: var(--radius-sm) !important; }
:deep(.ant-input:focus), :deep(.ant-input-focused) { border-color: var(--color-accent) !important; box-shadow: 0 0 0 3px rgba(29,78,216,0.1) !important; }
